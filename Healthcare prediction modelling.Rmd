...
Perhaps create code that will create or possible combinations of simple interactions.

# Interaction effects


```{r}
health_list <- healthcare3 %>% 
  select(-c(index, charges_int, where(is.numeric))) 
