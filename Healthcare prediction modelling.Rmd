...
The numerical variable `consult_in_ed` will be removed from the analysis, as it is methodologically not possible to include a character value as part of a continuous variable.
